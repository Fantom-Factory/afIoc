...
[![pod: v3.0.8](http://img.shields.io/badge/pod-v3.0.8-yellow.svg)](http://eggbox.fantomfactory.org/pods/afIoc)
...
Or install `IoC` with [fanr](https://fantom.org/doc/docFanr/Tool.html#install):
...
The easiest method of field injection is via a [it-block](https://fantom.org/doc/docLang/Fields.html#const) ctor parameter (see [This](https://fantom.org/doc/docLang/Closures.html#thisFunc)):
...
## <a name="lazyFunctions"></a>Lazy Functions
...
## <a name="serviceConfiguration"></a>Service Configuration
...
### <a name="overridingConfig"></a>Overriding Configuration
...
## <a name="dependecnyProviders"></a>Dependency Providers
