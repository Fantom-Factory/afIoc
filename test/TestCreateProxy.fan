...
internal class TestCreateProxy : IocTest {
	...
	Void testCreateProxyThreaded() {
		...
		s87 := (T_MyService87) reg.createProxy(T_MyService87#, T_MyService87Impl#, [69], [T_MyService87#num2:42])
		
		verifyFalse(s87.typeof.fits(T_MyService87Impl#))
		verifyEq(s87.reg.typeof, RegistryImpl#)
		verifyEq(s87.num,  69)
		verifyEq(s87.num2, 42)
	}

	Void testCreateProxyApp() {
		reg := RegistryBuilder().build.startup
		s88 := (T_MyService88) reg.createProxy(T_MyService88#, T_MyService88Impl#, [69], [T_MyService88Impl#num2:42])
		
		verifyFalse(s88.typeof.fits(T_MyService88Impl#))
		verifyEq(s88.reg.typeof, RegistryImpl#)
		verifyEq(s88.num,  69)
		verifyEq(s88.num2, 42)
	}
}
...
class T_MyService87Impl : T_MyService87 {
	...
	new make(Int num, Registry reg, |This|in) {
		in(this)
		this.num = num
		this.reg = reg
	}
